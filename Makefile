...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/04/05 18:56:13 by ashari            #+#    #+#              #
#    Updated: 2019/04/24 18:38:51 by ashari           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = libft.a
FILES = ft_memset.c ft_bzero.c ft_memcpy.c  ft_memccpy.c ft_memmove.c \
ft_memchr.c ft_memcmp.c ft_strlen.c ft_strdup.c ft_strndup.c ft_strcpy.c \
...
ft_lstmap.c ft_isupper.c ft_islower.c ft_isxdigit.c ft_isblank.c ft_isspace.c \
...
$(NAME):
	@gcc -c -I -Wall -Wextra -Werror  $(FILES)
	@ar rc $(NAME) $(OBJ)
	@ranlib $(NAME)
